"""
Django settings for marta_onthego_45909 project.
...
ROOT_URLCONF = 'marta_onthego_45909.urls'
...
WSGI_APPLICATION = 'marta_onthego_45909.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "marta_onthego_45909 API",
    "DESCRIPTION": "API documentation for marta_onthego_45909 App",
    "VERSION": "v1",
}
